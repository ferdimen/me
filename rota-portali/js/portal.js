...
function initMap() {
  ...
  // Sağa alt köşeye "GPX İndir" Butonu ekleme (Attribution hemen üstü)
...
async function handleGPXDownload() {
  ...
  try {
    // Bir üst dizindeki Zero Trust korumalı ozel.html sayfasına gizli istek atılır
    ...
    // Doğrulama yapılmamışsa (401, 403, opaqueredirect veya yönlendirme gelmişse)
    ...
    // Doğrulama başarılı ise GPX çıktısı verilir
